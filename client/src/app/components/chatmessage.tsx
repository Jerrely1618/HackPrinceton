        ...
        <div className={`flex flex-col ${sender === 'bot' ? 'items-start mb-7' : 'items-end mb-7'} gap-2`}>
            {sender === 'bot' && (
                <div className="flex items-start gap-2">
                    <div className="w-[35px] h-[35px] bg-white rounded-[100px] flex-col justify-center items-center gap-2 inline-flex">
                        ...
                        <div className={`px-4 py-2.5 rounded-tl-md rounded-bl-md rounded-br-md flex items-center mt-2`} style={{ ...messageBubbleStyles, maxWidth: 'calc(100% - 50px)' }}>
            ...
            {sender !== 'bot' && (
                <div className="flex flex-col items-end">
                    <div className={`px-4 py-2.5 rounded-tl-md rounded-bl-md rounded-br-md flex items-center `} style={{ ...messageBubbleStyles, maxWidth: 'calc(100% - 50px)' }}>
                        <div className="text-sm font-normal font-['Source Sans Pro'] leading-normal break-words">{message}</div>
                    </div>
