      ...
      <section className="middle flex flex-col gap-1 items-center justify-center w-full flex-[3_3_0%]">
        ...
        {cardSection === "analyze" ? (
          ...
          <>{transactions.map((transaction, index) => (
              <div key={index} className="flex flex-row items-center justify-center bg-white bg-opacity-10 backdrop-blur-sm shadow-lg p-1 rounded-2xl hover:shadow-2xl hover:bg-opacity-16 transition-shadow duration-300 mb-2 text-center gap-2 w-full">
